...
export function DataTable<TData, TValue>({
	...
	return (
		<>
			...
			<div className='flex flex-col gap-2 sm:flex-row sm:gap-0 justify-between w-full p-[24px] bg-white border-b border-slate/200'>
			...
			<Table>
				<TableHeader>
					{table.getHeaderGroups().map((headerGroup) => (
						<TableRow
							key={headerGroup.id}
							className='min-w-[700px] grid grid-cols-5'>
